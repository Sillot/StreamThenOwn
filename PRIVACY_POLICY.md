...
- **Artist name and album title** displayed on the currently viewed page of a supported streaming service (YouTube Music, Spotify, Apple Music)
...
Some purchase links generated by the extension may contain affiliate identifiers:

- **Qobuz via Awin**: Qobuz URLs may be redirected through Awin's tracking domain (`awin1.com`)

These affiliate links allow us to earn a small commission on qualifying purchases **at no additional cost to you**. When you click an affiliate link, the destination store may set its own cookies according to its own privacy policy. The extension itself does not set any cookies or track your clicks.

Affiliate identifiers are embedded at build time and are visible in the source code: https://github.com/Sillot/StreamThenOwn/blob/main/src/config/affiliate.ts
